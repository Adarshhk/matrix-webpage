<template>
    ...
    <div class="w-full my-4">
        ...
        <ul class="space-y-4 ">
            <li v-for="(feature, i) in elitePlan.features" :key="i" class="flex items-center gap-3">
    ...
    <div class="">
        ...
        <ul class="flex flex-wrap gap-4" >
            <li v-if="elitePlan.products.includes('wehook')">
            ...
            <li v-if="elitePlan.products.includes('signals')">
                <Tippy content_title="Webhook with partail access"
                    content_desc="Note : This is a premium feature, you will get partial access."
                    class="bg-[#272b2f] text-white p-2 rounded-lg">
            ...
            <li v-if="elitePlan.products.includes('manual_trade')">
                <Tippy content_title="Webhook with partail access"
                    content_desc="Note : This is a premium feature, you will get partial access."
                    class="bg-[#272b2f] text-white p-2 rounded-lg">
            ...
            <li v-if="elitePlan.products.includes('screener')">
                <Tippy content_title="Webhook with partail access"
                    content_desc="Note : This is a premium feature, you will get partial access."
                    class="bg-[#272b2f] text-white p-2 rounded-lg">
            ...
            <li v-if="elitePlan.products.includes('indicator')">
                <Tippy content_title="Webhook with partail access"
                    content_desc="Note : This is a premium feature, you will get partial access."
                    class="bg-[#272b2f] text-white p-2 rounded-lg">
            ...
            <li v-if="elitePlan.products.includes('algo_trading')">
                <Tippy content_title="Webhook with partail access"
                    content_desc="Note : This is a premium feature, you will get partial access."
                    class="bg-[#272b2f] text-white p-2 rounded-lg">
...
const elitePlan = computed(() => algoPricing.value[2]);
</script>