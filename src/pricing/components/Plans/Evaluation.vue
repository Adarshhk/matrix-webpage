<template>
    ...
    <div class="w-full my-4">
        ...
        <ul class="space-y-4 ">
            <li v-for="(feature, i) in evaluationPlan.features" :key="i" class="flex items-center gap-3">
    ...
    <div class="">
        ...
        <ul class="flex flex-wrap gap-4" >
            <li v-if="evaluationPlan.products.includes('wehook')">
            ...
            <li v-if="evaluationPlan.products.includes('signals')">
                <Tippy content_title="Webhook with partail access"
                    content_desc="Note : This is a premium feature, you will get partial access."
                    class="bg-[#272b2f] text-white p-2 rounded-lg">
            ...
            <li v-if="evaluationPlan.products.includes('manual_trade')">
                <Tippy content_title="Webhook with partail access"
                    content_desc="Note : This is a premium feature, you will get partial access."
                    class="bg-[#272b2f] text-white p-2 rounded-lg">
            ...
            <li v-if="evaluationPlan.products.includes('screener')">
                <Tippy content_title="Webhook with partail access"
                    content_desc="Note : This is a premium feature, you will get partial access."
                    class="bg-[#272b2f] text-white p-2 rounded-lg">
            ...
            <li v-if="evaluationPlan.products.includes('indicator')">
                <Tippy content_title="Webhook with partail access"
                    content_desc="Note : This is a premium feature, you will get partial access."
                    class="bg-[#272b2f] text-white p-2 rounded-lg">
            ...
            <li v-if="evaluationPlan.products.includes('algo_trading')">
                <Tippy content_title="Webhook with partail access"
                    content_desc="Note : This is a premium feature, you will get partial access."
                    class="bg-[#272b2f] text-white p-2 rounded-lg">
...
const evaluationPlan = computed(() => algoPricing.value[1]);
</script>