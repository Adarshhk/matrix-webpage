...
<!-- Call Correctly -->
<template>
    <div class="mx-auto px-0 2xl:px-16 py-12 mt-10">
      <div class="text-center mb-12">
        <h2 class="text-[38px] font-bold mx-auto text-white mb-8">
          Frequently asked question's
        </h2>
        <p class="text-gray-400 text-lg max-w-2xl mx-auto py-5 px-5">
