<template>
    <div class="mt-20 bg-gradient-to-b py-20 from-[#0A0A0A] to-[#222426] px-20">
        <div class="flex lg:flex-row justify-between flex-col mb-10">
            <div class="max-w-[26rem]">
                ...
                <p class="my-6 text-[16px] font-light text-[#F3F8F9] ">Our platform offers you an opportunity to fully
                    automate any of our strategies in your trading account and experience its accomplishment in the live
                    market. We also provide the opportunity to automate your own strategy in your trading account by
            ...
            <div class="">
                <ul>
                    ...
                    <li class="text-[#F3F8F9] font-light mb-2 hover:underline hover:cursor-pointer"><a
                            href="https://app.hifiinvesting.com/" target="_blank">Register Now</a></li>
                    <li class="text-[#F3F8F9] font-light mb-2 hover:underline hover:cursor-pointer"><a
                            href="#features">Features</a></li>
                    <li class="text-[#F3F8F9] font-light mb-2 hover:underline hover:cursor-pointer"><a
                            href="#pricing">Pricing</a></li>
                    <li class="text-[#F3F8F9] font-light mb-2 hover:underline hover:cursor-pointer"><a href="#why">Why
                            Us</a></li>
                </ul>
            </div>
            ...
            <div>
                <ul class="max-w-96">
                    ...
                    <li
                        class="text-[#F3F8F9] flex gap-3 items-center font-light mb-3 hover:underline hover:cursor-pointer">
                        <img src="/src/assets/svg/location.svg" alt="">
                        <p class="text-wrap">Matrix Trading Technologies, Vidhan Sabha Road, Dubey Colony , Raipur (C.G)
                            492007</p>
                    </li>
                    <li
                        class="text-[#F3F8F9] flex gap-3 items-center font-light mb-2 hover:underline hover:cursor-pointer">
        ...
        <div class="lg:p-10 border-t border-[#FFFFFF1A]">
            ...
            <p class="text-[#F3F8F9] text-[14px] text-center mt-16">Proudly designed and made by <span class="text-[#00B852]">X-tention crew technologies</span></p>
        </div>
