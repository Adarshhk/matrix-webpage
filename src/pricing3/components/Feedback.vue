<template>
        ...
        <div class="relative overflow-hidden bg-white rounded-lg shadow-lg" :style="{ backgroundColor: containerColor }">
          <div class="px-8 py-16 flex flex-col items-center justify-between h-full relative">
            <div class="space-y-6 text-center w-full max-w-2xl">
              <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold font-cabinet-grotesk leading-tight text-gray-800">
                Was this page helpful?
              </h2>
              <p class="text-lg md:text-xl font-proxima-nova text-gray-600">
              ...
              <div v-if="selectedEmoji !== null && !submitted" class="space-y-4">
                <p class="text-xl md:text-2xl font-semibold font-proxima-nova" :style="{ color: textColor }">
              ...
              <div v-if="submitted" class="mt-4 text-center">
                <p class="text-2xl md:text-3xl font-bold font-cabinet-grotesk" :style="{ color: textColor }">
  ...
  const submitFeedback = () => {
    if (selectedEmoji.value !== null) {
      ...
      console.log(`Feedback submitted: ${selectedEmoji.value}`)
