      ...
      <div class=" max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 p-4">
          ...
          <div class="flex flex-col items-center md:items-start justify-center p-4 ">
              ...
              <p class="text-[16px] mb-8 text-center md:text-left font-openSans ">
                Explore a world of trading wisdom through our carefully crafted videos. Learn, grow, and gain the confidence to make smarter moves in the market. Your success starts with the right knowledge—watch now to take control of your journey!
              </p>
