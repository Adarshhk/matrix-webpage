    ...
    <div class="w-full my-4">
        ...
        <ul class="space-y-4 ">
            <li v-for="(feature, i) in features.column1" :key="i" class="flex items-center gap-3">
                <img v-if="feature.active" src="/imgs/svg/cloud-green.svg" alt="Active Icon" class="w-5 h-5" />
                <img v-else src="/imgs/svg/cloud-gray.svg" alt="Inactive Icon" class="w-5 h-5" />
        ...
        <button
            ...
            <img src="/imgs/svg/add.svg" alt="" class="w-4">
